...
$(NAME):
	gcc $(FLAG) $(OPTION) ft_bzero.c    ft_isprint.c  ft_memset.c   ft_strcmp.c   ft_strncmp.c  ft_tolower.c ft_isalnum.c  ft_memccpy.c  ft_putchar.c  ft_strcpy.c   ft_strncpy.c  ft_toupper.c ft_isalpha.c  ft_memchr.c   ft_putstr.c   ft_strdup.c   ft_strnstr.c  islower.c ft_isascii.c  ft_memcpy.c   ft_strcat.c   ft_strlen.c   ft_strrchr.c  issame.c ft_isdigit.c  ft_memmove.c  ft_strchr.c   ft_strncat.c  isupper.c ft_strstr.c ft_memcmp.c ft_atoi.c ft_memalloc.c ft_memdel.c ft_strnew.c ft_strdel.c ft_strclr.c ft_striter.c ft_striteri.c ft_strmap.c
